...
console.log(
  ...
  chalk.hex('#89CFF0').italic('     last updated • 20 January 2026\n') +
  chalk.hex('#c084fc').italic('     Modification by @mamangwanzzselaluamanah\n') +
  chalk.hex('#a78bfa').italic('           telegram: @bochilteam\n\n') +
